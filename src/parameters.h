...
extern bool   patch_preserve_points;       // Keep original sync point groups in patch mode
...
extern bool   map_pub_en;
extern int    map_pub_interval;
extern bool   localization_enable, localization_publish_map, localization_wait_for_initial_pose;
extern std::string localization_map_path, localization_init_source, localization_initial_pose_topic;
extern double localization_map_voxel_size;
extern double localization_init_x, localization_init_y, localization_init_z;
extern double localization_init_roll, localization_init_pitch, localization_init_yaw;
